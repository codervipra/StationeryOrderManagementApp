...
class StationeryOrderManagement:
    def __init__(self, root):
        ...
        self.stationery_items = {"NOTEBOOK":3,"PENCIL PACK":2,"PEN SET":4,"ERASER":1,"GEOMETRY BOX":6,"COLOUR PENCILS":5}
    ...
    def setup_background(self, root):
        ...
        canvas.pack()
        original_image = tk.PhotoImage(file="study.png")
        background_image = original_image.subsample(original_image.width()//background_width,original_image.height()//background_height)
